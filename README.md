...
The pipeline filters low-value contigs, identifies potential misjoins (e.g., fused telomeres), visualizes breakpoints, and produces a corrected FASTA. It gives the user data to make inform curation decisions about which positions to break.
